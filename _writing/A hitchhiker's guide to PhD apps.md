---
title: "A hitchhiker's guide to PhD apps"
year: "2026"
category: "essay"
order: 1
...
longform: true
cover: /assets/images/phd-apps-cover.png
---
...
A big motivation for writing this is the example set by Lucy Lai ([https://lucylai.com/blog/gradapps](https://lucylai.com/blog/gradapps)) and Ya’el Courtney ([https://www.yaelcourtney.com/phdapplicationguide](https://www.yaelcourtney.com/phdapplicationguide)), whose guides were an immense help to me as I was gearing up to do this last Fall. I want to extend my gratitude to them and the many other generous colleagues who have contributed their time to demystifying this process for all. And, in the spirit of giving back, contribute my own little piece. 

I will also link [my Caltech statement of purpose](/assets/documents/original%5Bpersonal%20site%5D%20CalTech%20Statement%20of%20Purpose_Meng%20.pdf) here so you guys have a template to reference, should you need it\! 
...
* I spent 3 (wonderful) years in [Bernardo Sabatini’](https://sabatini.hms.harvard.edu/)s group (mentored by [Kevin Mastro](https://mastrok.github.io/)), where we investigated a number of questions related to circuit changes across the lifespan (adolescence, aging). I led a thesis project and contributed to a couple additional projects through the years.   
* I also very fortunately had the opportunity to learn genetic engineering in [George Church](https://churchlab.hms.harvard.edu/)’s group (mentored by [Juseong Lee](https://wyss.harvard.edu/team/postdoctoral-fellow/juseong-lee/)), where I built all sorts of constructs\!   
* My pride and joy through undergrad was the [OpenBio Lab](https://www.openbiolab.org/team), which I led from 2025 to 2026\. I believe very deeply in the power of citizen scientists and the future we can build as a generation equipped with biological know-how \+ tools. OpenBio’s overarching goal is to realize this democratization through a bunch of cool initiatives we run. I’d highly encourage you to check it out\!
...
<figure class="guide-figure cycle-map" aria-label="PhD application cycle overview">
  <figcaption>Application cycle at a glance</figcaption>
  <div class="cycle-track">
    <div><strong>1 year before</strong><span>Depth, letters, and purpose</span></div>
    <div><strong>Jun–Oct</strong><span>School list and research story</span></div>
    <div><strong>Nov–Dec</strong><span>Applications and submission</span></div>
    <div><strong>Jan–Mar</strong><span>Invitations and interviews</span></div>
    <div><strong>April</strong><span>Compare and decide</span></div>
  </div>
</figure>
...
2. **Mentor reputation and scientific networks.** I believe my mentors and their letters played an enormous role in getting me to the interview stage. A disproportionate number of my fellow interviewees came from labs I had heard a lot about.   
...
3. **Fellowships (Internal, National).** There are some incredibly high signal fellowships available to undergrads doing research. Many of the interviewees around me were [Goldwater Scholars](https://goldwaterscholarship.gov/) from their respective institution**,** had NSF-sponsored REUs, or had won internal fellowships of some sort. Some of the brightest scientists-in-training that I know were also [NewScience](https://newscience.org/one-year-fellowship/) recipients, TIME fellows \[*discontinued*\], etc.. 
...
6. **Fit.** At the end of the day, **fit is everything**. Even the most promising candidates I met this cycle (the ones who were all of the above), were not admitted everywhere. It really comes down to how well the work *you want to do* actually overlaps with the *work being done* in the department. 
...
<figure class="guide-figure funnel-map" aria-label="Program selection funnel">
  ...
  <div class="funnel-step"><strong>4</strong><span>Close reading, conversations, and outreach</span></div>
  <div class="funnel-step"><strong>5</strong><span>Final school list</span></div>
</figure>
...
![Excerpt from my statement of purpose][image1]
...
* **\[AMAZING, from my own observations\]** Harvard PiNBAC: two years of paid neuroscience research, curriculum, mentorship, and application support: [https://www.pinbac.org/](https://www.pinbac.org/)  
* Stanford Medicine Postbaccalaureate Experience in Research: a paid, structured biomedical research year (10.5 months): [https://postbacs.stanford.edu/about-the-program/](https://postbacs.stanford.edu/about-the-program/)  
* MIT Brain and Cognitive Sciences Research Scholars Program: a fully funded two-year program spanning cellular, systems, cognitive, computational neuroscience, and neuroengineering [https://bcs.mit.edu/postbac1](https://bcs.mit.edu/postbac1)  
* Washington University Neuroprep: two years of paid neuroscience research and professional development [https://neuroscience.wustl.edu/washington-university-launches-new-post-bacc-neuroscience-training-opportunity/](https://neuroscience.wustl.edu/washington-university-launches-new-post-bacc-neuroscience-training-opportunity/)  
* UCSF PREP: 1 year [https://postbac.ucsf.edu/](https://postbac.ucsf.edu/)  
* PennPREP: 1-2 years [https://www.med.upenn.edu/research-trainee-affairs/prep/](https://www.med.upenn.edu/research-trainee-affairs/prep/)  
* **\[Lots of my fellow interviewees trained did post-bac here\]** NIH Postbac IRTA: 1/2 years in an NIH lab [https://www.nimh.nih.gov/research/research-conducted-at-nimh/scientific-director/office-of-fellowship-and-training/fellowships-and-training-programs/postbaccalaureate-programs](https://www.nimh.nih.gov/research/research-conducted-at-nimh/scientific-director/office-of-fellowship-and-training/fellowships-and-training-programs/postbaccalaureate-programs)  
* University of Kentucky UKNeu-PREP: a two-year, paid neuroscience research and coursework program [https://medicine.uky.edu/departments/neuroscience/ukneu-prep](https://medicine.uky.edu/departments/neuroscience/ukneu-prep)

### Interviews

Lucy Lai’s guide was absolutely spot on about all of this\! Her descriptions, common questions, and advice were a great help (thank you so much Lucy). I won’t reinvent the wheel. You can find the link to her guide [here](https://lucylai.com/blog/gradapps). Please make sure to check it out, if you haven’t already\! 
...
6. What have you learned in the lab? Do you think you are prepared for your next step, whatever that may be?   
...
8. Can I see your apartment (you will get varying levels of enthusiasm in response)
...
*This resource was super helpful. [NSF GRFP Examples](https://docs.google.com/spreadsheets/d/1xoezGhbtcpg3BvNdag2F5dTQM-Xl2EELUgAfG1eUg0s/edit?gid=0#gid=0) (See Alex Lang’s NSF GRFP blog post). There, he also lists the questions on the application.* 
...
1. **Determine alignment criteria.**   
   ...
   * **and** view sector adjacent job listings (e.g. [Anthropic Research Scientist, Life Sciences](https://job-boards.greenhouse.io/anthropic/jobs/5239733008)). Aggregate key responsibilities, minimum and preferred qualifications, and skills (**skill map**)  
   * **(and)** identify relevant programs from funding bodies for high risk research, e.g. [DARPA](https://www.darpa.mil/research/programs), [ARIA](https://aria.org.uk/), etc (**frontier domain map**)

2. **Set skill, knowledge, and connection targets.** Compare your existing [career capital](https://80000hours.org/career-guide/career-capital/) to the [entry requirements](https://www.ox.ac.uk/admissions/graduate/courses/dphil-biomedical-sciences-nih-oxcam) and skill map. Identify:  
...
3. **Create a roadmap of projects and courses to maximise these criteria in the time available. Execute the plan.** Tips:  
   ...
   * Projects should be set at a level of [desirable difficulty](https://en.wikipedia.org/wiki/Desirable_difficulty).   
   ...
   * **Maximise feedback**. Share with your peers and mentors consistently. Ask for advice consistently. Thank them consistently. Take advantage of [extended cognition](https://fortelabs.com/blog/the-extended-mind-reimagining-the-nature-of-intelligence/).

**Background**  
I received full funding for the [ENAIBLE CDT](https://enaible.site.ox.ac.uk/) program at Oxford. Below I outline points of strategic interest for successful application.
...
Application strategy for **direct entry** is equivalent to that discussed by Sean above, with initial applications opening October, closing December, interviews in February, and place confirmation by July. The precise timeline will depend on course, with specific advice available on the [Graduate Admission](https://www.ox.ac.uk/admissions/graduate) page.
